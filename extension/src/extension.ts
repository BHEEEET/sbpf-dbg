...
import { activateDebug as activateSbpfDebug } from "./activateDebug";
...
export function activate(context: vscode.ExtensionContext) {
  ...
  switch (runMode) {
    case "server":
      activateSbpfDebug(context, new SbpfDebugAdapterServerDescriptorFactory());
      break;
    case "namedPipeServer":
      activateSbpfDebug(
        context,
        new SbpfDebugAdapterNamedPipeServerDescriptorFactory()
      );
      break;
    case "external":
    default:
      activateSbpfDebug(context, new DebugAdapterExecutableFactory());
      break;
    case "inline":
      activateSbpfDebug(context);
      break;
  }
}
...
class SbpfDebugAdapterServerDescriptorFactory
  implements vscode.DebugAdapterDescriptorFactory
{
...
class SbpfDebugAdapterNamedPipeServerDescriptorFactory
  implements vscode.DebugAdapterDescriptorFactory
{
  private server?: Net.Server;
